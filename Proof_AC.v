...
Proof.
  ...
  - assert (En_f X ⊂ pow(pow(X) × (∪pow(X)))).
    { unfold Included; intros.
      ...
      - unfold Included; intros; unfold Cartesian.
        PP' H10; apply AxiomII_P; repeat split; Ens.
  ...
  - intros; destruct H1.
    ...
    { split.
      ...
      - unfold Included; intros.
        ...
        unfold Cartesian; apply (Property_P' _); intros.
...
Proof.
  ...
  { assert (En_f X ⊂ pow(pow(X) × (∪pow(X)))).
    { clear H1; unfold Included; intros; unfold En_f in H0.
      ...
      - unfold Included; intros; unfold Cartesian.
        PP' H9; apply AxiomII_P; repeat split; Ens.
  ...
  destruct H3, H4 as [D H4], H4; apply Property_ProperSubset in H4; destruct H4.
  - double H4; apply Property_ProperSubset' in H6; destruct H6 as [E H6], H6.
    ...
    apply definition_not in H10; auto; clear H9.
    ...
    + { exists (D ∪ [E]); split.
        - unfold Included; intros; apply Theorem4 in H16; destruct H16.
          + unfold ProperSubset in H4; destruct H4.
        ...
        - assert (Function (F ∪ [[E,e]])).
          ...
          + intros; unfold ProperSubset in H15; destruct H15.
...
Hint Resolve Tukey_Choice : Axiom_of_Choice.
